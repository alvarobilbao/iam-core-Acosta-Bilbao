...
class TestUserDAO {
	...
	@Test
	void testCreateAndSearch() throws UserCreationException, IdentityCreationException, IdentitySearchException, UserSearchException {
		//Given
		...
		final List<User> resultList = userDao.searchAll(user);
